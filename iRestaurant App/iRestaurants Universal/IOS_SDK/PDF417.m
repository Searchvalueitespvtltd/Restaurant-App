...
- (IBAction)printBarcode
{
    ...
    [PrinterFunctions PrintPDF417CodeWithPortname:portName portSettings:portSettings limit:limit p1:height p2:width securityLevel:security xDirection:direction aspectRatio:ratio barcodeData:barcodeBytes barcodeDataSize:[barcodeData length]];
