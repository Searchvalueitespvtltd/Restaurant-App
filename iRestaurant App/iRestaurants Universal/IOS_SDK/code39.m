...
- (void)printBarCode
{
    ...
    NarrowWide     width  = selectedWidth;
    BarCodeOptions layout = selectedLayout;

    [PrinterFunctions PrintCode39WithPortname:portName portSettings:portSettings barcodeData:barcodeBytes barcodeDataSize:[barcodeData length] barcodeOptions:layout height:height narrowWide:width];
