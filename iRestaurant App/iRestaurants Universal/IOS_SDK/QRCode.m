...
- (IBAction)printQrcode
{
    ...
    CorrectionLevelOption correction = selectedCorrection;
    Model                 model      = selectedModel;
//  unsigned char         cell       = selectedCell;
    unsigned char         cell       = selectedCell + 1;

    [PrinterFunctions PrintQrcodeWithPortname:portName portSettings:portSettings correctionLevel:correction model:model cellSize:cell barcodeData:barcodeBytes barcodeDataSize:[barcodeData length]];
