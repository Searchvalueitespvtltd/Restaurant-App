...
- (IBAction)printBarCode
{
    ...
    [PrinterFunctions PrintCode93WithPortname:portName portSettings:portSettings barcodeData:barcodeBytes barcodeDataSize:[barcodeData length] barcodeOptions:layout height:height min_module_dots:width];
