...
//  unsigned char         module     = selectedModule;
    ...
    [MiniPrinterFunctions PrintQrcodePortname:portName portSettings:portSettings correctionLevelOption:correction ECLevel:code moduleSize:module barcodeData:barcodeBytes barcodeDataSize:[barcodeData length]];
