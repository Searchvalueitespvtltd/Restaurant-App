...
- (IBAction)printBarcode128
{
    ...
    Min_Mod_Size   width  = selectedWidth;
    BarCodeOptions layout = selectedLayout;

    [PrinterFunctions PrintCode128WithPortname:portName portSettings:portSettings barcodeData:barcodeBytes barcodeDataSize:[barcodeData length] barcodeOptions:layout height:height min_module_dots:width];
