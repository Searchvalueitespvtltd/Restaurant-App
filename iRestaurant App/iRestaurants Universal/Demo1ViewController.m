...
#define NUMBER_ITEMS_ON_LOAD 30
...
- (id)init
{
    if ((self =[super init])) 
    {
        ...
        {
            [_data addObject:[NSString stringWithFormat:@"T-%d", i]];
        }
...
- (void)loadView 
{
    ...
    GMGridView *gmGridView = [[GMGridView alloc] initWithFrame:CGRectMake(0, 40, self.view.bounds.size.width, self.view.bounds.size.height)];
    ...
    UIButton *bckButton = [UIButton buttonWithType:UIButtonTypeCustom];
    NSLog(@"origin: %f",self.view.bounds.origin.x);
    bckButton.frame = CGRectMake(self.view.bounds.origin.x-250,288,130,40);
                                 
    [bckButton setTitle:@"Back" forState:UIControlStateNormal];
    [bckButton setBackgroundColor:[UIColor blackColor]];
    bckButton.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleTopMargin;
    [bckButton addTarget:self action:@selector(backbtnAction) forControlEvents:UIControlEventTouchUpInside];
...
- (GMGridViewCell *)GMGridView:(GMGridView *)gridView cellForItemAtIndex:(NSInteger)index
{
    ...
    if (!cell) 
    {
        ...
        view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"red-table1"]];
...
- (void)GMGridView:(GMGridView *)gridView didTapOnItemAtIndex:(NSInteger)position
{
    ...
    NSLog(@"[[gridView subviews] objectAtIndex:position] %@",[[gridView subviews] objectAtIndex:position]);
    GMGridViewCell *cell=[[gridView subviews] objectAtIndex:position];
    ...
    [UIView animateWithDuration:0.3
                     ...
                     animations:^{
                         cell.contentView.backgroundColor = [UIColor  colorWithPatternImage:[UIImage imageNamed:@"blue-table1"]];
...
- (void)GMGridView:(GMGridView *)gridView didEndMovingCell:(GMGridViewCell *)cell
{
    [UIView animateWithDuration:0.3 
                        ...
                        options:UIViewAnimationOptionAllowUserInteraction 
                     animations:^{  
                         cell.contentView.backgroundColor = [UIColor  colorWithPatternImage:[UIImage imageNamed:@"red-table1"]];
                         cell.contentView.layer.shadowOpacity = 0;
                     }
                     completion:nil
     ];
